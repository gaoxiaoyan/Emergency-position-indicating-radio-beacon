...
void PrintfCmdList(void)
{
  ...
  Uart3SendString("# 16、cmd<21> -- 北斗卡号获取命令；\r\n");
  Uart3SendString("# 17、cmd<22> -- 北斗报文测试命令；\r\n");
  Uart3SendString("# 18、cmd<23> -- 北斗时间获取命令；\r\n");
  Uart3SendString("# 19、cmd<30> -- CDMA调试信息关闭；\r\n");
  Uart3SendString("# 20、cmd<31> -- CDMA调试信息打开；\r\n");
  Uart3SendString("# 21、cmd<32> -- 通过CDMA获取时间；\r\n");
  Uart3SendString("# 22、cmd<33> -- 设置CDMA本机号码；\r\n");
  Uart3SendString("# 23、cmd<34> -- 获取CDMA本机号码；\r\n");
  Uart3SendString("# 24、cmd<35> -- 设置CDMA接收号码；\r\n");
  Uart3SendString("# 25、cmd<36> -- 获取CDMA接收号码；\r\n");
  Uart3SendString("# 26、cmd<37> -- 获取CDMA信号强度；\r\n");
  Uart3SendString("# 27、cmd<38> -- CDMA短信发送测试；\r\n");
  Uart3SendString("###############################################################\r\n");
}
...
void SystemRunTimeGet(void)
{
  ...
  Uart3SendBuffer(&au8Minute[0], (i+1));
  Uart3SendString(" \r\n ");
  Uart3SendString("###############################################################\r\n");
}
