...
#define SYS_COM_SEL_ADDR    0x09    //通讯方式选取。 0 -- 根据信号强度自动选取； 1 -- 选择CDMA模块； 2 -- 选择北斗模块。
#define SYS_CMP_ADDR        0x10    //厂家标识
#define SYS_NBR_ADDR        0x18    //设备编码
...
typedef struct
{
  UINT16 u16CmpNbr;               //厂家标识, 0 ~ 65535.
  UINT16 u16SysNbr;               //设备编号, 0 ~ 65535.
  UINT8  u8SysType;               //设备类型, 0~255个类型；目前使用0 -- 收油机，1 -- 围油栏
