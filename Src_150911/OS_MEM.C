...
void  OS_MemInit (void)
{
    ...
    memset(au8LargeMem, 0, sizeof(au8LargeMem));
    pLargeMem = OSMemCreate(au8LargeMem, 4, BUF_LARGE_SIZE, &err);
    
    memset(au8MediumMem, 0, sizeof(au8MediumMem));
    pMediumMem = OSMemCreate(au8MediumMem, 4, BUF_MEDIUM_SIZE, &err);
    
    memset(au8SmallMem, 0, sizeof(au8SmallMem));
    pSmallMem = OSMemCreate(au8SmallMem, 12, BUF_SMALL_SIZE, &err);
}
#endif                                           /* OS_MEM_EN                                          */
