...
#define CMD_USE_BD_MODE           0x0c    /* 使用北斗模式通讯           */
#define CMD_USE_CDMA_MODE         0x0d    /* 使用CDMA模式通讯           */
#define CMD_USE_AUTO_MODE         0x0e    /* 使用自动通讯模式           */

#define CMD_GPS_INFO_CLOSE        0x10    /* GPS调试信息关              */
#define CMD_GPS_INFO_OPEN         0x11    /* GPS调试信息开              */

#define CMD_FLASH_LED_OFF         0x18    /* 关闭LED闪烁功能            */
#define CMD_FLASH_LED_ON          0x19    /* 打开LED闪烁功能            */
...
#define CMD_BD_SET_BCK_NUM        0x24    /* 北斗接收机备用卡号获取     */
#define CMD_BD_GET_BCK_NUM        0x25    /* 北斗接收机备用卡号设置     */
#define CMD_BD_INFO_TEST          0x26    /* 北斗发送报文测试           */
#define CMD_BD_GET_TIME           0x27    /* 北斗时间获取               */
#define CMD_BD_GET_SEND_SUC       0x28    /* 北斗发射成功率获取         */
#define CMD_BD_CLR_SEND_SUC       0x29    /* 北斗发射成功率清零         */
...
#define CMD_CDMA_SET_BCK_NUM      0x37    /* 设置备用发送号码           */
#define CMD_CDMA_GET_BCK_NUM      0x38    /* 获取备用发送号码           */
#define CMD_CDMA_GET_CSQ          0x39    /* 获取信号强度               */
#define CMD_CDMA_INFO_TEST        0x3a    /* 发送短信测试               */
#define CMD_CDMA_DEL_MSG          0x3b    /* 删除CDMA指定短信           */
