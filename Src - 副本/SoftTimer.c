...
*
*-----------------------------------------------------------------------------
* 修改时间：2015年5月4日08:41:08
* 描述：为方便查看所使用的定时器，增加设置其名称
*
*******************************************************************************/
...
//每个软件定时器占用7个byte，使用越多，占用内存越多, 中断负载越大
#define SWD_MAX_SIZE      16
 ...
 *       SWD_ERROR -- 设置失败
 *****************************************************************************/
SWD_STATUS SwdSetName(SINT8 s8Dog, UINT8 *pName)
{
