...
/*
#define EepromPower         BIT6
#define EepromPowerOut      P6OUT
#define EepromPowerDir      P6DIR
#define EepromPowerOn()     (EepromPowerOut |=  EepromPower)
#define EepromPowerOff()    (EepromPowerOut &= ~EepromPower)
*/
