...
void PrintfCmdList(void)
{
  ...
  Uart3SendString("#  8、cmd<07> -- 设置本台设备编码；\r\n");
  Uart3SendString("#  9、cmd<08> -- 获取本台设备编码；\r\n");
  Uart3SendString("# 10、cmd<10> -- GPS 调试信息关闭；\r\n");
  Uart3SendString("# 11、cmd<11> -- GPS 调试信息打开；\r\n");
  Uart3SendString("# 12、cmd<20> -- 北斗调试信息关闭；\r\n");
  Uart3SendString("# 13、cmd<21> -- 北斗调试信息打开；\r\n");
  Uart3SendString("# 14、cmd<22> -- 北斗发送报文测试；\r\n");
  Uart3SendString("# 15、cmd<30> -- CDMA调试信息关闭；\r\n");
  Uart3SendString("# 16、cmd<31> -- CDMA调试信息打开；\r\n");
  Uart3SendString("# 17、cmd<32> -- 通过CDMA获取时间；\r\n");
  Uart3SendString("# 18、cmd<33> -- 设置CDMA本机号码；\r\n");
  Uart3SendString("# 19、cmd<34> -- 获取CDMA本机号码；\r\n");
  Uart3SendString("# 20、cmd<35> -- 设置CDMA接收号码；\r\n");
  Uart3SendString("# 21、cmd<36> -- 获取CDMA接收号码；\r\n");
  Uart3SendString("# 22、cmd<37> -- 获取CDMA信号强度；\r\n");
  Uart3SendString("# 23、cmd<38> -- CDMA短信发送测试；\r\n");
  Uart3SendString("###############################################################\r\n");
}
